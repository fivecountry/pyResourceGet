...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "资源搜索下载器V1.3.3 项目地址：https://github.com/fivecountry/pyResourceGet"))
        ...
        self.btnClearFinished.setText(_translate("MainWindow", "清除所有已完成"))
